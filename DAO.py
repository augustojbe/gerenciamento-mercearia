...
class DaoVenda:
    ...
    def salvar(cls, venda: Venda):
        with open('venda.txt', 'a') as arq:
            arq.writelines(venda.itensVendidios.nome + "|" + venda.itensVendidios.preco + "|" + 
                           venda.itensVendidios.categoria + "|" + venda.vendedor + "|" + venda.comprador + "|" +
...
class DaoFornecedor:
    ...
    def ler(cls):
        ...
        for i in cls.fornecedor:
            fonr.append(Fornecedor(i[0], i[1], i[2], i[3]))
        return fonr
